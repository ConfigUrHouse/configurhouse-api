...
import type { ConfigurationValueAttributes, ConfigurationValueCreationAttributes } from "../configuration-value/configuration-value.class";
...
import type { ConsommationPosteConsoAttributes, ConsommationPosteConsoCreationAttributes } from "../consommation-poste-conso/consommation-poste-conso.class";
...
export function initModels(sequelize: Sequelize) {
  ...
  Configuration.belongsToMany(Value, { as: 'id_Values', through: ConfigurationValue as typeof Model, foreignKey: "id_Configuration", otherKey: "id" });
  Consommation.belongsToMany(PosteConso, { as: 'id_PosteConso_PosteConsos', through: ConsommationPosteConso as typeof Model, foreignKey: "id", otherKey: "id_PosteConso" });
  Email.belongsToMany(User, { as: 'id_Users', through: UserEmail as typeof Model, foreignKey: "id_Email", otherKey: "id" });
  Police.belongsToMany(User, { as: 'id_User_Users', through: UserPolice as typeof Model, foreignKey: "id", otherKey: "id_User" });
  PosteConso.belongsToMany(Consommation, { as: 'id_Consommations', through: ConsommationPosteConso as typeof Model, foreignKey: "id_PosteConso", otherKey: "id" });
  Role.belongsToMany(User, { as: 'id_User_Users', through: UserRole as typeof Model, foreignKey: "id", otherKey: "id_User" });
  User.belongsToMany(Email, { as: 'id_Email_Emails', through: UserEmail as typeof Model, foreignKey: "id", otherKey: "id_Email" });
  User.belongsToMany(Police, { as: 'id_Police', through: UserPolice as typeof Model, foreignKey: "id_User", otherKey: "id" });
  User.belongsToMany(Role, { as: 'id_Roles', through: UserRole as typeof Model, foreignKey: "id_User", otherKey: "id" });
  Value.belongsToMany(Configuration, { as: 'id_Configuration_Configurations', through: ConfigurationValue as typeof Model, foreignKey: "id", otherKey: "id_Configuration" });
  ...
  UserRole.belongsTo(User, { as: "id_User_User", foreignKey: "id_User"});
