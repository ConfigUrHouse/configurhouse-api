...
import { houseModelPosteConsoRouter } from './components/house-model-poste-conso/house-model-poste-conso.router';
...
(async () => {
  ...
  app.use('/houseModelPosteConso', houseModelPosteConsoRouter);
